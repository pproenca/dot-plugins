...
const PROGRAM_MARKERS = ["create a goal", "git show origin/main:", /30[- ]minute/, "status message"];
...
const boxes = (ls) =>
	ls.filter((l) => !l.code && BOX.test(l.text)).map((l) => ({ n: l.n, text: l.text.match(BOX)[1] }));
