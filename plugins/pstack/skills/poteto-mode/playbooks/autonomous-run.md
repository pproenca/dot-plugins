...
2. Pick the wake mechanism. An event such as CI, a merge, or a ref advancing gets a watcher. Add a Codex thread heartbeat automation as fallback. Without an event, use a heartbeat interval sized to when the result is worth re-checking.
