...
4. Verify each component against its baseline with an image diff through the matching control skill. A nonzero diff fails. Iterate per component until the diff is zero.
