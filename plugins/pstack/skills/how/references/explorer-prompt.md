...
Start by finding the relevant code. Search for directories, files, and key symbols. Read the matching source to understand the implementation. Don't guess from names.
