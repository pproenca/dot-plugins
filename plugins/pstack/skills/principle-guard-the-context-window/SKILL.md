...
- Keep successful check output and completed-phase evidence concise while retaining full artifacts where needed. At a meaningful handoff, carry forward the revision, relevant decisions, evidence locations, and remaining work. Do not force a reset or discard unresolved evidence to meet an arbitrary context target; repeated recovery can cost more than retaining useful context.
